    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.IntegerField(default=1, max_length=2, validators=[django.core.validators.MinLengthValidator(1)])),
                ('learn_unit', models.IntegerField(default=1, max_length=2, validators=[django.core.validators.MinLengthValidator(1)])),
